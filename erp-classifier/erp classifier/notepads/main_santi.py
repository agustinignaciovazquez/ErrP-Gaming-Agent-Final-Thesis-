...
experiences = trainerxdawn.get_epochs_data_list([
                                                #'../data/subject1/subject1-1/record-bv-generic-alex-[2019.06.15-18.43.41].vhdr',
                                                #'../data/subject1/subject1-2/record-bv-generic-alex-[2019.06.15-19.04.43].vhdr'
                                                '../data/subject2/subject2-1/record-bv-generic-gonza-[2019.05.25-14.37.56].vhdr',
                                                '../data/subject2/subject2-2/record-bv-generic-gonza-[2019.05.25-14.43.22].vhdr'
...
train_experiences = experiences[3:]
test_experiences = experiences[:3]
#print(test_experiences[0][0][0])

classifier = trainerxdawn.train_classifier(train_experiences, "classifiers.joblib", n=1)
classification = testerxdawn.test_classifier("classifiers.joblib", test_experiences, n=1)
...
utils.merge_predictions_with_states(classification, state_files, utils.grid_lights_rewards, "gonza4.txt")
