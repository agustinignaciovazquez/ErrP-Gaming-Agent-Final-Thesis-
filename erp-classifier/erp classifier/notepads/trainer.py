...
def get_experiences(file):
    ...
    for start, finish in zip(starts, finishes):
        experiences.append((epochs.get_data()[start+1:finish, :8, 1:], hit_epochs_labels[start+1:finish]))

    return experiences

def train_classifier(experiences, classifier_path, n=1, scikit_classifier=LogisticRegression()):
    """
    TODO: hacer bien
    :param experiences:
    :param experiences:
    ...
    for experience in experiences:
        ...
        epochs_data.extend(epochs_data_aux)
